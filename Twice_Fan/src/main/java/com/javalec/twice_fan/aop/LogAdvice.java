package com.javalec.twice_fan.aop;
...
// 컨트롤러,서비스,dao의 모든 method 실행 전후에 logPrint method가 호출됨
	@Around("execution(* com.javalec.twice_fan.controller..*Controller.*(..))"
			+ " or execution(* com.javalec.twice_fan.service..*Impl.*(..))"
			+ " or execution(* com.javalec.twice_fan.model..dao.*Impl.*(..))")
